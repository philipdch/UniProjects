...
public class W2VRetrieval {
    ...
    private static final  int TOP_RESULTS = 3204;
    ...
    public void testRankingWithTFIDFAveragedWordEmbeddings() throws Exception {
        ...
        try {
            ...
            if(choice==1){
                ...
                File gModel = new File("C:\\Users\\Philip\\Downloads\\7\\model.txt");
            ...
            try {
                ...
                String queryString;
                String id;
                Map<String, String> queriesU = RawQueryParser.parse("C:\\Users\\Philip\\Downloads\\cacm\\query.text");
...
//                            }
                            ...
                            if (vector != null&&reader.docFreq(new Term(queryTerm))>0) {
                                INDArray f=vector.div(n);

                                denseAverageTFIDFQueryVector.addi(f);

                            }else if(vector != null){
                                denseAverageTFIDFQueryVector.addi(vector);
                            }
                        }
                    }
                    ...
                    for (Map.Entry mapElement : sorted.entrySet()) {
                        ...
                        System.out.println(qid + " 0 " +key +" 0 " + value + " 1");
                        if(rep>=10){
                            break;
                        }
                        rep++;
