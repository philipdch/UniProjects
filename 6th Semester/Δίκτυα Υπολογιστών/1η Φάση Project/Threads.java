...
public class Threads extends Thread {
    ...
    public void login() throws IOException, ClassNotFoundException {
        ...
        String message;
        message = input.readUTF();
        System.out.println("print name" + message);
        ...
        //receive password
        message = input.readUTF();
        System.out.println("received pass word  " + message);
        boolean validPass;
        while (true) {
            validPass = false;
    ...
    public void replyList() throws IOException {
        ...
        filesList.addAll(caller.peerFileMap.keySet());
    ...
    private void getInfo(int token_id, String username) throws IOException, ClassNotFoundException {
        List<String> list = (ArrayList<String>) input.readObject();
        String ip;
        int port;
        //receive ip
        ...
        //create peerDetails
        PeerDetails peer = new PeerDetails(ip, port, token_id, username);
        ...
        //gia kathe string na elegxw an yparxei , an yparxei na prothesw to token id , alliws prosthetw kainoyrgio
